...
if __name__ == "__main__":
    ...
    while True:
        ...
        if 'wikipedia' in query:
            ...
            spotify = "C:\\Users\\svska\\AppData\\Roaming\\Spotify\\Spotify.exe"
            os.startfile(spotify)
        elif 'open code' in query:
            code = "C:\\Users\\svska\\AppData\\Local\\Programs\\Microsoft VS Code\\Code.exe"
            os.startfile(code)
        elif 'open photos' in query:
            folder = "D:\\svska\\Pictures\\Saved Pictures"
